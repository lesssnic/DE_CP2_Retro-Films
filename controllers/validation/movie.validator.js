...
exports.movieQuweryValidator = Joi.object().keys({
    ...
    release_date_first: Joi.string().isoDate().allow(null, '').empty(['', null]).default('1950-01-01'),
    release_date_last: Joi.string().isoDate().allow(null, '').empty(['', null]).default('2022-01-01'),
